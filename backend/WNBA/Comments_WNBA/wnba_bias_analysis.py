#This file is responsible for performing bias and sentiment analysis on WNBA comments from a text file
import sys
import pandas as pd
...
# Handles Input Files
input_file = sys.argv[1] if len(sys.argv) > 1 else 'The_Day_Caitlin_Clark_Showed_Angel_Reese_Who’s_Boss_comments.txt'
base_name = input_file.replace('_wnba_processed_comments.csv', '')
output_file = f'{base_name}_wnba_analysis_sentiment_results.xlsx'


# Reads the input files as plain text
try:
