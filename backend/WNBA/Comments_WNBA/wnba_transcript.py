# This file is in charge of fetching comments from a YouTube video using the YouTube Data API v3 (for WNBA)
from googleapiclient.discovery import build
import os

API_KEY = 'YOUR_YOUTUBE_API_KEY'  # Set as environment variable or .env in production
