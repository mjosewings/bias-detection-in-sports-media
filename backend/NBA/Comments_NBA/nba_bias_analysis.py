# This File is responsible for performing bias and sentiment analysis on NBA comments.
import sys
import pandas as pd
...
# Handles input files
input_file = sys.argv[1] if len(sys.argv) > 1 else 'LeBron_&_AD_Too_Big_For_Curry_|_Game_1_Lakers_v_Warriors_2023_NBA_Playoffs_comments.txt'
base_name = input_file.replace('_nba_processed_comments.csv', '')
output_file = f'{base_name}_nba_analysis_sentiment_results.xlsx'


# Reads input file as plain text
try:
